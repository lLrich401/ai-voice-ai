...
try {
    ...
    tar.exe --exclude='model/runtime/src/src' --exclude='model/df_arena/*.ort' --exclude='model/df_arena/.cache' --exclude='model/*_tmp.pt' --exclude='model/aasist_64.pt' --exclude='model/aasist_best.pt' --exclude='model/heuristic.pt' --exclude='model/music_spec_cnn.pt' --exclude='model/stageA_aasist.pt' --exclude='model/voice_aasist.pt' --exclude='model/voice_spec_cnn.pt' --exclude='*__pycache__*' --exclude='*.pyc' -a -c -f $archive model script.py requirements.txt
